...
proc create_root_design { parentCell } {
  ...
  set CAN_1_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:can_rtl:1.0 CAN_1_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_CAN_1 [get_bd_intf_ports CAN_1_0] [get_bd_intf_pins processing_system7_0/CAN_1]
